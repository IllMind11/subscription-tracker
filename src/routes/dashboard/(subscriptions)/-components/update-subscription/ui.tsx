import type { ISubscription } from '~/shared/api/subscriptions'
import type { BillingPeriod } from '~/shared/types'
import { zodResolver } from '@hookform/resolvers/zod'
import { useQueryClient } from '@tanstack/react-query'
import { format } from 'date-fns'
import { CalendarIcon, ImagePlus, PenBox } from 'lucide-react'
...
import { useGetImageByIdQuery, useUploadImageMutation } from '~/shared/api/images'
...
export function UpdateSubscription({
  ...
  const { mutate: updateSubscription, isPending: isUpdateSubscriptionPending } = useUpdateSubscriptionMutation()
  ...
  const onSubmit = form.handleSubmit((data) => {
    ...
    if (data.image) {
      ...
      handleCreateSubscription(subscription.file_id)
    }
  })
          ...
          <Form {...form}>
            ...
            >
              ...
              <Button
                ...
                isLoading={isUpdateSubscriptionPending || isUploadImagePending}
              >
                Сохранить
              </Button>
            </form>
